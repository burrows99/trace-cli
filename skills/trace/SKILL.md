...
full execution trace in one shot. One engine, two protocol drivers — **CDP** for Node/Chrome, **DAP** for
Python. You read the trace; you never drive the debugger by hand.
